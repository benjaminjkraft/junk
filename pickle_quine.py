...
PART_2 = (
    ...
    pickle.TUPLE2, pickle.REDUCE,               # call --> slice(0, 4)
    pickle.BINPUT, b'\x04',                     # store that in memo 4

    pickle.BINGET, b'\x02',                     # load slice from memo 2
    pickle.BININT1, b'\x04',                    # put 4 on stack
    pickle.NONE,                                # put None on stack
    pickle.TUPLE2, pickle.REDUCE,               # call --> slice(4, None)
    ...
    pickle.BINGET, b'\x04',                     # load slice(0, 4) from memo 4
    ...
    pickle.BINGET, b'\x00',                     # load the string from memo 0
    pickle.BINGET, b'\x05',                     # slice(4, None) from memo 5
    pickle.TUPLE2, pickle.REDUCE,               # tuple + call --> string[4:]
    pickle.BINPUT, b'\x07',                     # store that in memo 7

    pickle.BINGET, b'\x03',                     # load operator.add from memo 3
    pickle.BINGET, b'\x06',                     # load string[:4] from memo 6
    ...
    pickle.BINGET, b'\x07',                     # load string[4:] from memo 7
