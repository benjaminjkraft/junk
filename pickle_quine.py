...
PART_2 = (
    ...
    BINPUT, b'\x03',                            # store that in memo 3

    BINGET, b'\x02',                            # load slice from memo 2
    BININT1, b'\x00',                           # put 0 on stack
    BININT1, b'\x04',                           # put 4 on stack
    TUPLE2, REDUCE,                             # call --> slice(0, 4)
    ...
    BINGET, b'\x01',                            # load getitem from memo 1
    BINGET, b'\x00',                            # load the string from memo 0
    BINGET, b'\x04',                            # load slice(0, 4) from memo 4
    TUPLE2, REDUCE,                             # tuple + call --> string[:4]
    BINPUT, b'\x06',                            # store that in memo 6

    BINGET, b'\x01',                            # load getitem from memo again
    BINGET, b'\x00',                            # load the string from memo 0
